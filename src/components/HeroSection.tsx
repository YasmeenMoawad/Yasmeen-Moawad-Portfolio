      ...
      >
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            >
              A flutter geek with 1+ year of professional experience developing production mobile applications for clients across the Gulf, MENA region, and America. I have experience leading successful teams and participating in competitive contests to gain valuable experience and enhance my problem-solving abilities. Volunteered in many organizations to learn and share my knowledge with others.
            </motion.p>
            ...
            >
              {[
                ...
                { href: "https://mail.google.com/mail/?view=cm&fs=1&to=yasmeenmwd@gmail.com", icon: Mail, label: "Email", color: "bg-terracotta" },
